...
The function also skips links to [line permalinks](/starlight-codeblocks/features/line-permalinks/). [Use with other plugins](/starlight-codeblocks/guides/use-with-other-plugins/#starlight-links-validator) has the full set-up.
