...
- A space renders as a middle dot, and a tab as an arrow that fills the width of the tab.
...
- [Comment notation](/starlight-codeblocks/features/comment-notation/): the directive syntax that the examples on this page also use.
